...
(function(){
    ...
    function insertSingle(){
        var width = $G("videoWidth") || 10,
            height = $G("videoHeight") || 10,
    ...
    function insertUpload(){
        var videoObjs=[],
            ...
            width = $G('upload_width') ? parseInt($G('upload_width').value, 10) : 50,
            height = $G('upload_height') ? parseInt($G('upload_height').value, 10) : 20,
