...
<html>
  ...
  <body>
        ...
        <fieldset style="border:solid 0px #aaa;padding:3px;">
            ...
            <table>
            <tr>
               <td><input name="num0" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num1" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num2" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num3" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num4" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num5" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
               <td><input name="num6" class="mini-textbox" style="width:20px;" inputStyle="color:red;" vtype ="int" maxlength="1"/></td>
            </tr>
            </table>            
            </div>
        </fieldset>
