  ...
  <body>
        ...
        <fieldset style="border:solid 0px #aaa;padding:3px;">
            ...
            <tr>
               ...
               <td><input name="num12" class="mini-textbox" style="width:20px;" inputStyle="color:red;" maxlength="1"/></td>
               <td><input name="num13" class="mini-textbox" style="width:20px;" inputStyle="color:red;" maxlength="1"/></td>
            </tr>
            </table>            
            </div>
        </fieldset>
