...
<div class="mini-toolbar" style="border-top:0;border-left:0;padding:0px;">
	<div id="form">
		<table style="width:100%;">
			<tr>
				<td width="15%" >
					彩期：<input id="lotteryIssueSelect" name="lotteryIssueSelect" class="mini-combobox" popupHeight="700px;" popupMaxHeight="700px;" style="width:150px;" emptyText="请选择"
							   allowInput="true" value="" showClose="true" nullItemText="请选择..." showNullItem="true" onCloseClick="lottery_wf.comboxOnCloseClick"/>
					<input id="lotteryIssue"  name="lotteryIssue" value="" class="mini-textbox" style="width:100px;" emptyText="输入彩期"/>
					<a class="mini-button" onclick="lottery_wf.runTask(1,this)">获取比赛</a>
					<a class="mini-button" onclick="lottery_wf.runTask(2,this)">同步分析数据</a>
                    <a class="mini-button" onclick="lottery_wf.runTask(3,this)">抓取比分</a>
                    <a class="mini-button" onclick="lottery_wf.runTask(4,this)">审核比分与彩果</a>
                    <a class="mini-button" onclick="lottery_wf.runTask(5,this)">开奖</a>
                    <btn:operate privilege="EXPORT">
			        	<a class="mini-button" iconCls="icon-download" plain="true" onclick="lottery_wf.excel()">导出</a>
			        </btn:operate>
				</td>
			</tr>
			<tr>
				<td width="5%" style="white-space:nowrap;">
					...
					{ "id": "周六", "text": "周六" },
					{ "id": "周日", "text": "周日" }
					]'  class="mini-combobox" style="width:100px;"
								 emptyText="请选择" allowInput="true" valueFromSelect="true" showClose="true" nullItemText="请选择..." showNullItem="true" onCloseClick="lottery_wf.comboxOnCloseClick"/>
					...
					赛事状态：<input id="matchStatus1" name="matchStatus" data="Dic.matchStatus" value="" class="mini-combobox" style="width:150px;"
								emptyText="请选择" allowInput="true" valueFromSelect="true" showClose="true" onCloseClick="lottery_wf.comboxOnCloseClick"
			...
			<tr>
				<td>
					...
					到<input id="matchEndTime" name="matchEndTime" class="mini-datepicker" allowInput="false" style="width:200px;"
							format="yyyy-MM-dd HH:mm:ss" timeFormat="HH:mm:ss" showTime="true" showOkButton="true"
							showClearButton="false"/>
					<a class="mini-button" onclick="lottery_wf.search()">查询</a>
				</td>
			</tr>
		</table>
	</div>
...
<div class="mini-splitter" vertical="true" style="width:100%;height:100%;" style="border:0;">
	<div size="90%" showCollapseButton="true" style="border:0;">
		<div id="datagrid" class="mini-datagrid" onpreload="MiniCom.onpreload" allowAlternating="true"  borderStyle="border:solid 0px;"
			 ...
			 url="lotterymgr/wf/list" idField="againstId" allowResize="true" pageSize="30" multiSelect="false"
			 showColumnsMenu="true" showFilterRow="false" showPager="true"
			...
			<div property="columns">
				...
				<div field="matchType" renderer="lottery_wf.onMatchTypeRenderer" type="comboboxcolumn" headerAlign="center" align="center" width="60">体育类型
				</div>
				<div field="startTime" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss" width="125">
					比赛时间
				...
				<div field="letNum" headerAlign="center" align="center" width="60">让分
				</div>
				...
				<div field="saleEndTime" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss" width="125">
					销售截止时间
				...
				<div field="spLetWf" property="editor" headerAlign="center" align="center">SP值
				...
				<div field="wrong" renderer="lottery_wf.setWrong" headerAlign="center" align="center">其他数问题</div>
				<div field="opt" renderer="lottery_wf.onActionRenderer" headerAlign="center" align="center">操作
				</div>
			</div>
		</div>
	</div>
...
<div id="editWindow" class="mini-window" title=""
	...
	<div id="editform">
		<input name="url" value="lotterymgr/wf" class="mini-hidden"/>
		<input name="action" value="post" class="mini-hidden"/>
		<input name="againstId" class="mini-hidden"/>
		<input name="matchPrimaryId" class="mini-hidden"/>
		<input name="homeTeamPrimaryId"  class="mini-hidden"/>
		<input name="guestTeamPrimaryId"  class="mini-hidden" />
		<input name="sportDrawWfId" class="mini-hidden"/>
		<input name="sportStatusWfId" class="mini-hidden"/>
		<input id="matchId" name="matchId" class="mini-hidden"/>
		<input id="homeTeamId" name="homeTeamId" class="mini-hidden"/>
		<input id="guestTeamId" name="guestTeamId" class="mini-hidden" />
		<table width="100%" border="0" cellpadding="2" cellspacing="2">
			<tr>
				...
				<td width="50%" style="text-align: right;">
					...
					<a class="mini-button" onclick="lottery_wf.submit"  iconCls="icon-save" >保存</a>
				</td>
			</tr>
		</table>
				...
				<table width="100%">
					...
					<tr>
						<td width="15%" style="text-align: center;">
							...
							<input type="button" value="修改" onclick="lottery_wf.ajaxFileUpload('matchImg','logoUrl','matchfile')"/></td>
					...
					<table width="100%">
						...
						<tr>
							<td width="15%" style="text-align: center;">
								...
								<input type="button" value="修改" onclick="lottery_wf.ajaxFileUpload('homeImg','homeLogoUrl','homefile')"/></td>
							<td width="10%">球队排名</td>
							...
							<td width="15%" style="text-align: center;">
								...
								<input type="button" value="修改" onclick="lottery_wf.ajaxFileUpload('guestImg','guestLogoUrl','guestfile')"/></td>
						</tr>
					</table>
				</div>
			</tr>
					...
					<div style="margin: 20px;">
						<table width="100%" >
							<tr>
								...
								<td width="15%">
									<input id="fullScore" name="fullScore" onvaluechanged="lottery_wf.scoreValueChange" vtype="score" class="mini-textbox" style="width:200px;" />
								</td>
								<td width="15%" style="text-align: center">
									开奖时间:
								</td>
							...
							<tr>
								...
								<td width="15%" style="text-align: center">
									<table  width="100%" class="table-bor">
										<tr>
											<td width="50%">
												<input id="letNum" name="letNum"  readOnly="true"  class="mini-textbox asLabel" style="width:50px;" />
											</td>
											<td width="50%">
												<span id="letSf"></span>
											</td>
				...
				<div>
					...
					<div style="margin: 20px;">
						...
						<table width="100%" class="table-bor" style="margin-top: 20px;">
							<tr>
								<td width="15%" style="text-align: left" >
									...
									<span style="float: right;">
										子玩法状态:
										<input id="statusLetWf" name="statusLetWf" class="mini-combobox" data="Dic.sportFbChildPayStatus" style="width:100px;"/>
										&nbsp; &nbsp; &nbsp; &nbsp;
									</span>
								</td>
							</tr>
							<tr>
								<td>
									<div id="sportDataSfWFBOs" class="mini-datagrid"  style="width:100%;height:200px;"
										...
										<div property="columns">
											...
											<div  field="letScore" headerAlign="center" align="center" >让球
											</div>
...
<script src="<%=basePath%>resources/js/lotterymgr/lottery_wf.js?version=<%=version%>" type="text/javascript"></script>
</html>
