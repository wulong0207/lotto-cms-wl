...
<div class="mini-toolbar" style="border-top:0;border-left:0;padding:0px;">
	<div id="form">
		<table style="width:100%;">
			<tr>
				<td width="15%" >
					彩期：<input id="lotteryIssueSelect" name="lotteryIssueSelect" class="mini-combobox" style="width:150px;" popupHeight="700px;" popupMaxHeight="700px;" emptyText="请选择"
							   allowInput="true" value="" onCloseClick="lottery_bb.comboxOnCloseClick" showClose="true" nullItemText="请选择..." showNullItem="true"/>
					<input id="lotteryIssue"  name="lotteryIssue" value="" class="mini-textbox" style="width:100px;" emptyText="输入彩期"/>
					<a class="mini-button" onclick="lottery_bb.runTask(1, this)">获取比赛</a>
					<a class="mini-button" onclick="lottery_bb.runTask(2, this)">同步分析数据</a>
                    <a class="mini-button" onclick="lottery_bb.runTask(3, this)">抓取比分</a>
                    <a class="mini-button" onclick="lottery_bb.runTask(4, this)">审核比分与彩果</a>
                    <a class="mini-button" onclick="lottery_bb.runTask(5, this)">开奖</a>
                    <btn:operate privilege="EXPORT">
			        	<a class="mini-button" iconCls="icon-download" plain="true" onclick="lottery_bb.excel()">导出</a>
			        </btn:operate>
				</td>
			</tr>
			<tr>
				<td width="5%" style="white-space:nowrap;">
					...
					{ "id": "周六", "text": "周六" },
					{ "id": "周日", "text": "周日" }
					]'  class="mini-combobox" style="width:100px;" onCloseClick="lottery_bb.comboxOnCloseClick"
					...
					赛事状态：<input id="matchStatus1" name="matchStatus" data="Dic.matchStatus" value="" class="mini-combobox" onCloseClick="lottery_bb.comboxOnCloseClick" style="width:150px;"
								emptyText="请选择" allowInput="true" valueFromSelect="true" showClose="true"
			...
			<tr>
				<td>
					...
					到<input id="matchEndTime" name="matchEndTime" class="mini-datepicker" allowInput="false" style="width:200px;"
							format="yyyy-MM-dd HH:mm:ss" timeFormat="HH:mm:ss" showTime="true" showOkButton="true"
							showClearButton="false"/>
					<a class="mini-button" onclick="lottery_bb.search()">查询</a>
				</td>
			</tr>
		</table>
	</div>
...
<div class="mini-splitter" vertical="true" style="width:100%;height:100%;" style="border:0;">
	<div size="90%" showCollapseButton="true" style="border:0;">
		<div id="datagrid" class="mini-datagrid" onpreload="MiniCom.onpreload" allowAlternating="true"  borderStyle="border:solid 0px;"
			 ...
			 url="lotterymgr/bb/list" idField="againstId" allowResize="true" pageSize="30" multiSelect="false"
			...
			<div property="columns">
				...
				<div field="letScore" property="editor"  headerAlign="center" align="center" width="60">让分
				</div>
				<div field="presetScore" property="editor" headerAlign="center" align="center" width="60">预设总分
				</div>
				...
				<div field="notSalePay" type="comboboxcolumn" property="editor" headerAlign="center" align="center" width="60">未开售玩法
					<div class="mini-combobox" property="editor" data="Dic.sportBBChildPay"  popupWidth="200" textField="text" valueField="id"
				...
				<div field="wrong" renderer="lottery_bb.setWrong" width="70" headerAlign="center" align="center">其他数问题</div>
				<div field="opt" renderer="lottery_bb.onActionRenderer" width="100" headerAlign="center" align="center">操作
				</div>
			</div>
		</div>
	</div>
...
<div id="editWindow" class="mini-window" title=""
	...
	<div id="editform">
		...
		<input name="sportStatusBbId" class="mini-hidden"/>
		<input name="sportDrawBbId" class="mini-hidden"/>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="2">
			<tr>
				...
				<td width="50%" style="text-align: right;">
					...
					<a class="mini-button" onclick="lottery_bb.submit"  iconCls="icon-save" >保存</a>
				</td>
			</tr>
		</table>
				...
				<table width="100%">
					...
					<tr>
						<td width="15%" style="text-align: center;">
							...
							<input type="button" value="修改" onclick="lottery_bb.ajaxFileUpload('matchImg','logoUrl','matchfile')"/></td>
				...
				<div id="secondWindow">
					...
					<table width="100%">
						<tr>
							...
							<td width="10%">球队全称</td>
							<td width="15%"><input id="guestTeamFullName"  name="guestTeamFullName" class="mini-textbox asLabel" readOnly="true" value="textbox"  /></td>
							<td width="10%">球队全称</td>
						...
						<tr>
							<td width="10%">球队简称</td>
							<td width="15%"><input id="guestTeamShortName" name="guestTeamShortName"  class="mini-textbox" style="width:200px;" /></td>
							<td width="10%">球队简称</td>
						...
						<tr>
							...
							<td width="15%"><input id="guestTeamDataUrl" name="guestTeamDataUrl"  class="mini-textbox" style="width:200px;" /></td>
							<td width="10%">球队资料ID</td>
						...
						<tr>
							<td width="15%" style="text-align: center;">
								...
								<input type="button" value="修改" onclick="lottery_bb.ajaxFileUpload('guestImg','guestLogoUrl','guestfile')"/>
								</td>
							<td width="10%">球队排名</td>
							<td width="15%"><input id="guestTeamOrder" name="guestTeamOrder"  class="mini-textbox" style="width:200px;" /></td>
							<td width="10%">球队排名</td>
							...
							<td width="15%" style="text-align: center;">
								...
								<input type="button" value="修改" onclick="lottery_bb.ajaxFileUpload('homeImg','homeLogoUrl','homefile')"/>							
								</td>
						</tr>
					</table>
				</div>
					...
					<div style="margin: 20px;">
						<table width="100%" >
							<tr>
								...
								<td width="35%">
									<input id="firstScore" name="firstScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:60px;" />
									<input id="secondScore" name="secondScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:60px;" />
									<input id="thirdScore" name="thirdScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:60px;" />
									<input id="fourthScore" name="fourthScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:60px;" />
									<input id="outTimeScore" name="outTimeScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:60px;" />
								</td>
								<td width="10%" style="text-align: center">
									全场比分:
								</td>
								<td width="10%">
									<input id="fullScore" name="fullScore" vtype="score" onblur="lottery_bb.scoreValueChange" class="mini-textbox" style="width:100px;" />
								</td>
								<td width="15%" style="text-align: center">
									开奖时间:
								</td>
					...
					<div style="margin: 20px;">
						<table width="100%" >
							...
							<tr>
								...
								<td width="15%">
									<input id="startTime" name="startTime" class="mini-datepicker"  allowInput="false" style="width:150px;"
										   format="yyyy-MM-dd HH:mm:ss" timeFormat="HH:mm:ss" showTime="true" showOkButton="true"
										   showClearButton="false"/><a class="mini-button" onclick="lottery_bb.restartThread">重启线程</a>
								</td>
								<td width="15%" style="text-align: center">
									截止时间:
								</td>
						...
						<table width="100%" class="table-bor" style="margin-top: 20px;">
							<tr>
								<td width="15%" style="text-align: left" >
									...
									<span style="float: right;">
										子玩法状态:
										<input id="statusWf" name="statusWf" class="mini-combobox" data="Dic.sportBBChildPayStatus"  style="width:100px;"/>
										&nbsp; &nbsp; &nbsp; &nbsp;
									</span>
								</td>
							</tr>
							<tr>
								<td>
									<div id="notLetSportDataBbWFBOs" class="mini-datagrid" style="width:100%;height:200px;"
						...
						<table width="100%" class="table-bor" style="margin-top: 20px;">
							<tr>
								<td width="15%" style="text-align: left" >
									...
									<span style="float: right;">
										子玩法状态:
										<input id="statusLetWf" name="statusLetWf" class="mini-combobox" data="Dic.sportBBChildPayStatus"  style="width:100px;"/>
										&nbsp; &nbsp; &nbsp; &nbsp;
									</span>
								</td>
							</tr>
							<tr>
								<td>
									<div id="letSportDataBbWFBOs" class="mini-datagrid" style="width:100%;height:200px;"
										 allowResize="true"   multiSelect="true"  showPager="false">
										<div property="columns">
											<div field="releaseTime" width="25%" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">发布时间</div>
											<div  field="letScore" width="20%" headerAlign="center" align="center" >让分
											</div>
											<div  field="spWin" width="20%" headerAlign="center" align="center" >胜
											</div>
											<div   field="spFail" width="20%"headerAlign="center" align="center">负
											</div>
										</div>
									</div>
								</td>
						...
						<table width="100%" class="table-bor" style="margin-top: 20px;">
							<tr>
								<td width="15%" style="text-align: left" >
									...
									<span style="float: right;">
										子玩法状态:
										<input id="statusBigSmall" name="statusBigSmall" class="mini-combobox" data="Dic.sportBBChildPayStatus"  style="width:100px;"/>
										&nbsp; &nbsp; &nbsp; &nbsp;
									</span>
								</td>
							</tr>
							<tr>
								<td>
									<div id="sportDataBbSSSBOs" class="mini-datagrid" style="width:100%;height:200px;"
										  allowResize="true"   multiSelect="true"  showPager="false">
									<div property="columns">
										<div field="releaseTime" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">发布时间</div>
										<div  field="presetScore" headerAlign="center" align="center" >预设总分
										</div>
										<div   field="spBig" headerAlign="center" align="center">大分
										</div>
										<div   field="spSmall" headerAlign="center" align="center">小分
										</div>
									</div>
								</div></td>
						...
						<table width="100%" class="table-bor" style="margin-top: 20px;">
							<tr>
								<td width="15%" style="text-align: left" >
									...
									<span style="float: right;">
										子玩法状态:
										<input id="statusScoreWf" name="statusScoreWf" class="mini-combobox" data="Dic.sportBBChildPayStatus"  style="width:100px;"/>
										&nbsp; &nbsp; &nbsp; &nbsp;
									</span>
								</td>
							</tr>
							<tr>
								<td>
									<div id="sportDataBbWSBOs" class="mini-datagrid" style="width:100%;height:200px;"
										  allowResize="true"   multiSelect="true"  showPager="false">
										<div property="columns">
											<div field="releaseTime" headerAlign="center" align="center" dateFormat="yyyy-MM-dd HH:mm:ss">发布时间</div>
											<div header="客胜"  headerAlign="center" align="center">
												<div  property="columns">
													<div  field="spFail15" headerAlign="center" align="center" >1-5
													</div>
													<div   field="spFail610" headerAlign="center" align="center">6-10
													</div>
													<div   field="spFail1115" headerAlign="center" align="center">11-15
													</div>
													<div   field="spFail1620" headerAlign="center" align="center">16-20
													</div>
													<div   field="spFail2125" headerAlign="center" align="center">21-25
													</div>
													<div   field="spFail26" headerAlign="center" align="center">26+
													</div>
												</div>
											</div>
											<div header="主胜"  headerAlign="center" align="center">
												<div  property="columns">
													<div   field="spWin15" headerAlign="center" align="center">1-5
													</div>
													<div   field="spWin610" headerAlign="center" align="center">6-10
													</div>
													<div   field="spWin1115" headerAlign="center" align="center">11-15
													</div>
													<div   field="spWin1620" headerAlign="center" align="center">16-20
													</div>
													<div   field="spWin2125" headerAlign="center" align="center">21-25
													</div>
													<div   field="spWin26" headerAlign="center" align="center">26+
													</div>
												</div>
											</div>
										</div>
...
<script src="<%=basePath%>resources/js/lotterymgr/lottery_bb.js?version=<%=version%>" type="text/javascript"></script>
</html>
