  ...
  <div class="mini-toolbar" style="border-top:0;border-left:0;padding:0px;">
  	<div id="form1">
		<table style="width:100%;">
			<tr>
				<td>
					&nbsp;&nbsp;&nbsp;&nbsp;<a class="mini-button" onclick="lottery_gj.draw">开奖</a>
				</td>
			</tr>
			<tr>
				<td width="10%" nowrap="nowrap">
					...
					销售状态<input id="matchStatus" name="matchStatus" class="mini-combobox"  style="width:150px;"
							   emptyText="请选择" oncloseclick="Cms.onCloseClick" showClose="true"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
			        <a class="mini-button" onclick="lottery_gj.search">查询</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="datagrid" class="mini-datagrid" onpreload="MiniCom.onpreload" allowAlternating="true" borderStyle="border:solid 0px;" style="width:100%;height:87%;" 
		 url="lotterymgr/gj/page" idField="id" allowResize="true" multiSelect="true"
		...
		<div property="columns">
			...
			<div renderer="lottery_gj.onActionRenderer" headerAlign="center" align="center">操作</div>

		</div>
	</div>
  </body>
<script src="<%=basePath%>resources/js/public/common.js?vsersion=<%=System.currentTimeMillis()%>" type="text/javascript"></script>
<script src="<%=basePath%>resources/js/lotterymgr/lottery_gj.js?vsersion=<%=System.currentTimeMillis()%>" type="text/javascript"></script>
</html>
