...
<div id="rcmdGrid" class="mini-datagrid" allowAlternating="true" style="width: 100%; height: 100%;"
    ...
    <div property="columns">
        ...
        <div field="pay2c1Counts" headerAlign="center" align="center">收费2串1发单数</div>
        <div field="payDgCounts" headerAlign="center" align="center">收费单关发单数</div>
        <div field="buyCounts" headerAlign="center" align="center">总购买人数</div>
        <div field="buy2c1Counts" headerAlign="center" align="center">2串1购买数</div>
        <div field="buyDgCounts" headerAlign="center" align="center">单关购买数</div>
...
<script src="<%=basePath%>resources/js/rcmd/rcmd.js?version=<%=version%><%=System.currentTimeMillis() %>"
