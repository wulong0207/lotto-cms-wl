...
<html>
  ...
  <div class="mini-toolbar" style="border-top:0;border-left:0;padding:0px;">
		...
		<table style="width:100%;">
			<tr>
				<td width="10%" nowrap="nowrap">
					...
					直属会员账号：<input name="memberAccount" class="mini-textbox"/>
					&nbsp;&nbsp;&nbsp;
			        <a class="mini-button" onclick="agent_direct.search">查询</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="datagrid" class="mini-datagrid" onpreload="MiniCom.onpreload" allowAlternating="true" borderStyle="border:solid 0px;" style="width:100%;height:87%;" 
		 url="agent/direct/page" idField="id" allowResize="true" multiSelect="true"
		...
		<div property="columns">
			...
			<div field="memberAccount" headerAlign="center" align="center">下级直属用户账号</div>
			<div field="memberRealName" headerAlign="center" align="center">直属用户真实姓名</div>
...
<script src="<%=basePath%>resources/js/agent/agent_direct.js?vsersion=<%=System.currentTimeMillis()%>" type="text/javascript"></script>
</html>
