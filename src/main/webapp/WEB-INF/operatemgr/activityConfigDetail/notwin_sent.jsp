...
<body>
	    <div id="activityConfigForm" class="form">
		    ...
		    <fieldset style="border:solid 1px #aaa; padding:3px;">
	            ...
	            <tr>
	                ...
	                <td width="15%">活动对象</td>
	                <td width="35%">
						<div id="userType" name="userType" class="mini-radiobuttonlist" textField="text" valueField="id" >
						</div>
	                </td>
	            </tr>
	        </table>
			  ...
			  <fieldset style="border:solid 1px #aaa; padding:3px;height: 500px;">
		  		...
		  		<div id="activityRule_datagrid" class="mini-datagrid"  onpreload="MiniCom.onpreload" allowAlternating="true" borderStyle="border:solid 0px;" style="width:100%;height:350px;"
						...
						<div property="columns">
							...
							<div field="winStartMoney" headerAlign="center" align="center">最小购彩金额</div>
							<div field="winEndMoney" headerAlign="center" align="center">最大购彩金额</div>
	...
	<div id="activityRuleWindow" class="mini-window" style="width:55%;height:28%" showFooter="true" showModal="true" allowResize="true" allowDrag="true">
 		<div property="footer" style="text-align:right;padding:5px;padding-right:15px;">
	    <btn:operate privilege="ADD|UPD">
	    ...
	    <div id="activityRuleForm" class="form">
           ...
           <tr>
               <td width="25%">玩法</td>
               <td><input id="lotteryPassType" name="lotteryPassType" class="mini-combobox" style="width: 180px;" emptyText="请选择" valueFromSelect="true" required="true"/></td>
               <td></td>
               <td></td>
           </tr>
           <tr>
           ...
           <tr>
               ...
               <td>
				   ...
				   <input id="winEndMoney" name="winEndMoney" class="mini-textbox" style="width: 180px;" required="true" onvalidation="Current.floatValid"/>
			   </td>
           </tr>
           <tr>
               <td>本站返利金额</td>
               <td>
				   ...
				   &nbsp;&nbsp;&nbsp;&nbsp;<input id="rebateNum" name="rebateNum" class="mini-textbox" style="width: 180px;" required="true"/>
			   </td>
           </tr>
           <tr>
               <td>是否有效</td>
...
<script src="<%=basePath%>resources/js/operatemgr/activityConfigDetail/notwin_send.js?vsersion=<%=version%>" type="text/javascript"></script>
