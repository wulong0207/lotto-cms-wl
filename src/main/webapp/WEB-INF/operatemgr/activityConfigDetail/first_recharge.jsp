...
<body>
	    <div id="activityConfigForm" class="form">
		    ...
		    <fieldset style="border:solid 1px #aaa; padding:3px;">
	            ...
	            <tr>
	                <td style="width:100px;">最低充值金额</td>                
	                <td style="width:150px;">
	                	<input id="minRechargeMoney" name="minRechargeMoney" style="width:80%;" class="mini-textbox"/>	                
	                </td>
	...
	<div id="activityRuleWindow" class="mini-window" style="width:70%;height:40%" showFooter="true" showModal="true" allowResize="true" allowDrag="true">
 		<div property="footer" style="text-align:right;padding:5px;padding-right:15px;">
	    <btn:operate privilege="ADD|UPD">
...
<script src="<%=basePath%>resources/js/operatemgr/activityConfigDetail/first_recharge.js?vsersion=<%=version%>" type="text/javascript"></script>
